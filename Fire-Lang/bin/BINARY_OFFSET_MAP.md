...
- **COLOR_SPACE:** `[@]0x0F12:0120`  
  - symbolic values: `CVBGOD_GREEN`, `CVBGOD_RED`  
- **HWND_BINDING:** `[@]0x0F12:0150 → [@]0x0360`  
...
- **SILICON_POST_ID:** `[@]0x0F00:0008`  
  - symbolic value: `ID_0x4F_VERIFIED`  
